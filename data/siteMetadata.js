const siteMetadata = {
  ...
  analytics: {
    ...
    googleAnalyticsId: 'G-2GJN3P7RBT', // e.g. UA-000000-2 or G-XXXXXXX
  ...
  comment: {
    ...
    giscusConfig: {
      ...
      // https://giscus.app/
      repo: proecess.env.NEXT_PUBLIC_GISCUS_REPO,
      repositoryId: proecess.env.NEXT_PUBLIC_GISCUS_REPOSITORY_ID,
      category: proecess.env.NEXT_PUBLIC_GISCUS_CATEGORY,
      categoryId: proecess.env.NEXT_PUBLIC_GISCUS_CATEGORY_ID,
