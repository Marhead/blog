      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="flex h-full overflow-hidden rounded bg-white dark:bg-gray-900">
          <a className="position: relative flex flex-wrap no-underline hover:no-underline">
                ...
                <div class="bg-white dark:bg-gray-900 w-full text-xl md:text-2xl text-gray-800 leading-normal rounded-t">
                    ...
                    return (
                      <>
                        <div class="flex h-full bg-white rounded overflow-hidden shadow-lg">
                          <a href={`/blog/${slug}`} class="flex flex-wrap no-underline hover:no-underline">
